...
## APK Nasıl Alınır?
Bu repoda her güncelleme yapıldığında **GitHub Actions** otomatik olarak bir APK derler. 
APK'yı indirmek için üstteki **Actions** sekmesine gidin, son başarılı işleme tıklayın ve sayfanın en altındaki **Artifacts** kısmına bakın.